...
class LectureController extends Controller
{
    ...
    {    
        return view('tutor.lectures.create', compact('contentId'));
    }
    ...
    public function store(LectureRequest $request, $contentId)
    {
        ...
        return redirect('/tutor/courses/'.$lecture->course_id);
       } 
...
return response(file_get_contents($file),200) ->header('Content-Type',$content_types);
    ...
    public function edit($contentId, $id)
    {
       ...
       return view('tutor.lectures.edit', compact('lecture'))->with('contentId', $contentId)->with('id', $id);
    }
