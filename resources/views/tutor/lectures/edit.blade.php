...
{!! Form::model($lecture, ['files'=>'true','method'=> 'PATCH', 'route'=>['tutor.contents.lectures.update', $contentId, $id]]) !!}
...
<div class="col-sm-12">
    {!! Form::file('document',null,['class'=>'form-control']) !!}
      @if(isset($lecture->document))                   
  
<a class="btn btn-xm btn-info col-sm-2" href="/download/{{$lecture->document}}" target="_blank"> Download File</a>
