...
@section('title', 'Quiz| Questions | Single| Edit')
@section('main_title')
...
@foreach($question->answer as $ans)
 ...
 <input type="text" name="answer[]" class="form-control col-sm-2" value="{{$ans->answer}}">

<div class="col-sm-3">

 <input type="checkbox" name="is_correct[]" value="1" {{1==$ans->is_correct?'checked':''}}> is Correct
