...
@section('title', 'Quiz| Questions | Multiple')
@section('main_title')
<i class="fa fa-question-circle" aria-hidden="true"></i>  Quizes
@endsection
@section('sub_title', 'Multiple')
...
@endsection
@section ('current_page')
<a href="javascript:history.back()" style="color: black;" target="_self"> Quiz </a> <li>  Add question </li> <li> <a href="/tutor/questions/multiple/create" style="color: black;" target="_self"> Multiple</a> </li>
@endsection
...
{!! Form::open(['files'=>'true','route'=>['tutor.questions.type.store',$type]]) !!}
