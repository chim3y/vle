...
@section('title', 'Quiz| Questions | Fill in the blanks')
@section('main_title')
...
@endsection
@section ('current_page')
<a href="javascript:history.back()" style="color: black;" target="_self"> Quiz </a> <li>  Add question </li> <li> <a href="/tutor/questions/fill-in-blanks/create" style="color: black;" target="_self"> Fill in blanks </a> </li>
@endsection
