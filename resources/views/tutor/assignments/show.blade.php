...
<div class="row"> 
<div class="form-group"> 
<h4> {!! Form::label('left_date','Remaining Days',['class'=>'col-sm-3 control-label']) !!} </h4>
<div class="col-sm-9">
...
<div class="row"> 
<div class="form-group"> 
<h4> {!! Form::label('max_grade','Max Grade',['class'=>'col-sm-3 control-label']) !!} </h4>
<div class="col-sm-9">
...
$(function() {
    $('#courses_table').DataTable({
        ...
        processing: true,
        serverSide: true,
          ajax:"{{ route('tutor.submissionData', array('id'=>$assignment->id, 'contentId'=>$assignment->content_id)) }}" ,
        columns: [
