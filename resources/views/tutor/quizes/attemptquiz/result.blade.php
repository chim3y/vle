...
<div style="height: 90px;
  ...
  @if( $userpercentage <40 )
   <h1> <i class="fa fa-hand-o-right" aria-hidden="true"></i> <a href="{{ route('tutor.quiz.show', [$quiz->id, str_slug($quiz->quiz_name)]) }}" style="color: black;" target="_self">  PLEASE TRY AGAIN </a> </h1>
