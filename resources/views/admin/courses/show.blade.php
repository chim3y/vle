...
<table class="table table-bordered table-condensed" style="border: 1px solid black" >
  ...
  <tr>
  <th class="col-md-4" style="border: 1px solid black; text-align: center"> <span class="glyphicon glyphicon-user"> </span>&nbsp; Taught by;  </th>
...
<div class="well well-sm">
    ...
    <button class="btn btn-link" name="edit" id="edit" style="color:black; font-size:14px"> <a href="{{ url('/admin/contents/'.$content->id.'/edit')}}" target="_self" style="color:black"> edit </a>  </button> 
...
<div class="box box-solid  box-info collapsed-box ">
        <div class="box-header with-border">
          <h3 class="box-title" style="display:inline-block"> <a href="{{ route('admin.lectures.show', [$lecture->id, str_slug($lecture->lecture_name)]) }}" style="color: black;" target="_self"> <strong> <i class="fa fa-file"> </i> &nbsp; {{ \Illuminate\Support\Str::upper($lecture->lecture_name ) }} </strong> </a> </h3> 

       
          <div class="box-tools pull-right">

           <button class="btn btn-box-tool  btn-link "  style="color:black; font-size:14px">  <a  href="{{ URL::route('admin.contents.lectures.edit', array('contentId'=> $content->id, 'id'=> $lecture->id )) }}" target="_self" style="color:black"> edit </a>  </button> 
...
<div class="box box-solid  box-info collapsed-box ">
        <div class="box-header with-border">
          <h3 class="box-title" style="display:inline-block"> <a href="{{ route('admin.assignments.show', [$assignment->content_id,$assignment->id, str_slug($assignment->assignment_title)]) }}" style="color: black;" target="_self"> <strong> <i class="fa fa-tasks"> </i> &nbsp; {{ \Illuminate\Support\Str::upper($assignment->assignment_title ) }} </strong> </a> </h3> 

       
          <div class="box-tools pull-right">

            <button class="btn btn-box-tool  btn-link "  style="color:black; font-size:14px">  <a  href="{{ URL::route('admin.contents.assignments.edit', array('contentId'=> $content->id, 'id'=> $assignment->id )) }}" target="_self" style="color:black"> edit </a>  </button> 
...
<div class="box box-solid box-info collapsed-box ">
        <div class="box-header with-border">
          <h3 class="box-title"  style="display:inline-block"> <a href="{{ route('admin.quiz.show', [$quiz->id, str_slug($quiz->quiz_name)]) }}" style="color: black;" target="_self"> <strong> <i class="fa fa-pencil-square"> </i> &nbsp; {{ \Illuminate\Support\Str::upper($quiz->quiz_name ) }}  </strong> </a </h3> 

       
          <div class="box-tools pull-right">

           <button class="btn btn-link btn-box-tool"  style="color:black; font-size:14px">  <a  href="{{ URL::route('admin.contents.quizes.edit', array('contentId'=> $content->id, 'id'=> $quiz->id )) }}" target="_self" style="color:black"> edit </a>  </button> 
 

          {!! Form::open(['action' => ['Admin\QuizesController@destroy', 'id'=> $quiz->id], 'method' => 'delete', 'style'=>' display:inline-block']) !!}
    <button class="btn btn-link btn-box-tool" style="color: black; font-size:14px"> delete </button>
 {!! Form::close() !!} 
