...
@section('main_title')
<i class="fa fa-question-circle" aria-hidden="true"></i>  Attempt
@endsection
...
<a href="{{ route('admin.quiz.attemptquiz', [$quiz->id, str_slug($quiz->quiz_name)]) }}" class="btn btn-default"> Start Quiz</a>
