...
{!! Form::model($quiz,['method'=>'PATCH', 'action'=>['Admin\QuizesController@update', $contentId,$id]]) !!}
...
$(function() {
    $('#questions_table').DataTable({
        ...
        processing: true,
        serverSide: true,
          ajax:"{{ route('admin.contents.quizes.questionsData', array('id'=>$id, 'contentId'=>$contentId)) }}" ,
        columns: [
