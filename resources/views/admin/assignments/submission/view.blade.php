...
{!! Form::model($submission,['files'=>'true','method'=>'PATCH', 'action'=>['Admin\AssignmentSubmissionController@update', "contentId"=>$assignment->content_id, "assignmentId"=>$assignment->id, "id"=>$submission->id ]]) !!}
<div class="row">
<div class="form-group"> 
